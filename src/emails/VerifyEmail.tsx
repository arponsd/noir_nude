...
export function VerifyEmail({ verifyUrl, name }: VerifyEmailProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>Verify your GlowCart email</Preview>
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          <Heading style={headingStyle}>Welcome to GlowCart</Heading>
          <Text style={textStyle}>{greeting}</Text>
          <Text style={textStyle}>
            Please confirm your email address so you can start shopping. This link expires in 24
            hours.
          </Text>
          ...
          <Text style={linkStyle}>{verifyUrl}</Text>
          <Text style={mutedStyle}>
